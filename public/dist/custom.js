...
var app = new Vue({
	...
	methods: {
		removeErrorClass: function removeErrorClass($event) {
		...
		songAdd: function songAdd() {
			var _this = this;
			var data = new FormData();
			data.append('name', _this.newSongName);

			axios.post(baseurl + 'api/song/add', data).then(function (response) {
		...
		youTubeEmbed: function youTubeEmbed(str) {
			str.substring(str.indexOf("=") + 1);
		},
		removeClass: function removeClass(elements, myClass) {
