...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dist/all-styles.min.css?v=1488298324209') }}">
...
<script src="{{ asset('dist/all-vendor-scripts.js?v=1488298324209') }}"></script>
<script src="{{ asset('dist/custom.js?v=1488298324209') }}"></script>
